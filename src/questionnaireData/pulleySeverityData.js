export const PULLEY_SEVERITY_DATA = {
    injuryType: {
        ...
        photos: [],
        answers: [
            { id: "injuryTypeAnswer1", text: "Traumatic (occurred as a result of obvious sudden trauma – typically an unexpected overload of the tissue in a single obvious event/moment", scores: { A: 0, B: 1, C: 1, D: 1, E: 1, F: 0, G: 0, H: 0, I: 0, J: 0, K: 0, L: 0, M: 0, N: 0 } },
            { id: "injuryTypeAnswer2", text: "Non-traumatic acute (no obvious traumatic event but clearly a result of OVERDOING IT on a SINGLE climb or session)", scores: { A: 1, B: 1, C: -1, D: -2, E: -3, F: 0, G: 0, H: 0, I: -1, J: -1, K: -3, L: 0, M: 0, N: 0 } },
