...
const handleSubmit = (finalResponses = responses) => {
  ...
  const NerveIssueScore = scores['H'] || 0;
    ...
    if (/💪/.test(resultsSummary)) {
      ...
      additionalDetails = "Great job completing the primary assessment! Based on your results, you should now move on to Differential Assessment 2.";
