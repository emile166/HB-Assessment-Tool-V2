...
function Differential3Questionnaire({ questionnaire, onBack, primaryResults }) {
    ...
    return (
      <Layout>
        <Card ref={questionnaireContainerRef}>
          <AppHeader />
          <ResultsCard
            title="Differential Assessment 3 Results"
...
export default Differential3Questionnaire;